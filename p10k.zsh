# Generated by Powerlevel10k configuration wizard on 2020-02-27 at 10:13 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(kubecontext rbenv aws nordvpn)
  ...
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=$blue
